...
export default function Header() {
  ...
  const adminLinks = [
    ...
    {
      href: "/addHospitalStaff",
      text: "Add Hospital Staff",
      icon: <FaUserMd />,
    },
    {
      href: "/addBloodCampStaff",
      text: "Add BloodCamp Staff",
      icon: <MdPersonAdd />,
    },
      ...
      <Container maxW="container.xl">
        <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
          <img
            ...
            alt="Logo"
          />
          <Text color="white" fontWeight={500} fontSize={25}>
            NationBlood
          </Text>
